...
function MovieList() {
  const movieDetails = [
    ...
    },
    {
      ...
      poster:
        "https://m.media-amazon.com/images/I/81VMYoT--IL._UF1000,1000_QL80_.jpg",
      rating: 8.1,
      summary:
...

    {
      name: "Thor: Ragnarok",
      poster:
        "https://m.media-amazon.com/images/M/MV5BMjMyNDkzMzI1OF5BMl5BanBnXkFtZTgwODcxODg5MjI@.V1.jpg",
      summary:
        "When Earth becomes uninhabitable in the future, a farmer and ex-NASA\\n pilot, Joseph Cooper, is tasked to pilot a spacecraft, along with a team\\n of researchers, to find a new planet for humans.",
      rating: 8.8,
    },
